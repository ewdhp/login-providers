...
import{ encode as base64Encode, decode as base64Decode } 
...
const generateKeysFromSub = async (sub) => {
  ...
  const hashBuffer = await crypto
    .subtle.digest('SHA-256', encodedSub);   
...
const customJsonSerializer = (value) => {
